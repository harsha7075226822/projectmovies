...
const Login = () => {
  ...
  return (
    <div className="h-screen w-full bg-[url('https://res.cloudinary.com/dcttatiuj/image/upload/v1756136399/8ccaf66f19edc15e3aa6b6a1301fd6667bf2509e_1_xkw5s3.jpg')] bg-cover bg-center relative flex items-center justify-center">
      {/* Overlay */}
      <div className="absolute inset-0 bg-black/60"></div>

      {/* Header Logo (Image) */}
      <header className="absolute top-6 left-10 z-20">
        <img
      ...
      {/* Login Box */}
      <div className="relative z-10 bg-black/70 p-10 rounded-xl w-[350px] border border-blue-400 shadow-lg">
        ...
        <form className="flex flex-col space-y-5" onSubmit={handleSubmitForm}>
          ...
          <div>
            ...
            <input
              ...
              value={username}
              className="w-full p-3 mt-1 bg-gray-800 text-white rounded focus:outline-none focus:ring-2 focus:ring-red-600"
          ...
          {isErr ? <p className="text-red-500">{showErrorMsg}</p> : '' }
          {/* Submit Button */}
          <button
            type="submit"
